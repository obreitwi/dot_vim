...
autocmd vimrc FileType markdown,norg    nmap <silent> <localleader>tt :call fzf#run(fzf#wrap({'source': 'revcli tasks --list --title --json', 'sink': function("InsertTaskDetails"), 'options': '-d "	" --with-nth 1'}))<CR>
